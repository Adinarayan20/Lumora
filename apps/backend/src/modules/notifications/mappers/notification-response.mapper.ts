...
export class NotificationResponseMapper {
  public static toResponseDto(aggregate: NotificationAggregate): NotificationResponseDto {
    return {
      id: aggregate.id.toString(),
      workspaceId: aggregate.workspaceId.toString(),
      userId: aggregate.userId.toString(),
      reminderId: aggregate.reminderId ? aggregate.reminderId.toString() : undefined,
      ...
      deliveredAt: aggregate.deliveredAt ? aggregate.deliveredAt.toISOString() : undefined,
