...
import type { NotificationStatus, NotificationChannel } from '../value-objects/notification-enums.js';
...
export interface INotificationRepository
  extends IPaginatedRepository<NotificationAggregate, UniqueEntityId, NotificationFilter> {
