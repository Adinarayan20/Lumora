...
export const STARTER_LIBRARY_CATALOG: readonly TemplatePackage[] = Object.freeze([
  {
    manifest: {
      ...
      description: 'Capture daily reflections, gratefulness notes, mood tracking, and audio memos.',
  ...
  },
  {
    manifest: {
      ...
      description: 'Manage high-level objectives, project milestones, and action items.',
  ...
  },
  {
    manifest: {
      ...
      description: 'Store reading notes, book summaries, and interconnected knowledge concepts.',
  ...
  },
  {
    manifest: {
      ...
      description: 'Track income, recurring expenses, and subscription renewal dates.',
