...
import { getRegisteredIcon, registerDomainIcon } from './Icon.registry';
...
describe('Icon Primitive & Registry Subsystem Hardening', () => {
  ...
  it('allows dynamic registration of domain extension icons via registerDomainIcon', () => {
  ...
  describe('Accessibility State Machine Contract Matrix', () => {
